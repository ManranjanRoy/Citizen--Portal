...
public class FeePaymentListAdaptor extends RecyclerView.Adapter<FeePaymentListAdaptor.ImageViewHolder> {
    private Context mContext;
    private List<FeePaymentModel> mUploads;
    ...
    public FeePaymentListAdaptor(Context mContext, List<FeePaymentModel> mUploads) {
    ...
    public void onBindViewHolder(final ImageViewHolder holder, int position) {
        ...
        final FeePaymentModel uploadCurrent = mUploads.get(position);
