...
public class SingleTradeTypesforForm4Adaptor extends RecyclerView.Adapter<SingleTradeTypesforForm4Adaptor.ImageViewHolder> {
    ...
    public SingleTradeTypesforForm4Adaptor(Context mContext, List<TradeNatureModel> mUploads) {
    ...
    public void onBindViewHolder(final ImageViewHolder holder, int position) {
        ...
        holder.texttime.setText(uploadCurrent.getType());
